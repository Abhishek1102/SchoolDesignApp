...
public class GravitySnapHelper extends LinearSnapHelper {
    ...
    private com.example.schoolproject.helper.GravitySnapHelper.SnapListener listener;
    private RecyclerView recyclerView;
    private RecyclerView.OnScrollListener scrollListener = new RecyclerView.OnScrollListener() {
        @Override
        public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
            super.onScrollStateChanged(recyclerView, newState);
            com.example.schoolproject.helper.GravitySnapHelper.this.onScrollStateChanged(newState);
        }
    };
    ...
    /**
     * Changes the gravity of this {@link com.example.highlighttime.helper.GravitySnapHelper}
     ...
     *                        and snap according to {@link com.example.highlighttime.helper.GravitySnapHelper#getSnapLastItem()},
    ...
    /**
     * Unlike {@link com.example.highlighttime.helper.GravitySnapHelper#scrollToPosition(int)},
     * this method will generally always find a snap view if the position is valid.
     * <p>
     * The smooth scroller from {@link com.example.highlighttime.helper.GravitySnapHelper#createScroller(RecyclerView.LayoutManager)}
     * will be used, and so will {@link com.example.highlighttime.helper.GravitySnapHelper#scrollMsPerInch} for the scroll velocity
     *
     * @return true if scroll was successful, false otherwise
     */
    ...
    /**
     * @return last distance set through {@link com.example.highlighttime.helper.GravitySnapHelper#setMaxFlingDistance(int)}
     * or {@link com.example.highlighttime.helper.GravitySnapHelper#FLING_DISTANCE_DISABLE} if we're not limiting the fling distance
     */
     ...
     *                 or {@link com.example.highlighttime.helper.GravitySnapHelper#FLING_DISTANCE_DISABLE}
    ...
    /**
     * @return last distance set through {@link com.example.highlighttime.helper.GravitySnapHelper#setMaxFlingSizeFraction(float)}
     * or {@link com.example.highlighttime.helper.GravitySnapHelper#FLING_SIZE_FRACTION_DISABLE}
    ...
    /**
     * @return last scroll speed set through {@link com.example.highlighttime.helper.GravitySnapHelper#setScrollMsPerInch(float)}
     * or 100f
     */
     ...
     * {@link com.example.highlighttime.helper.GravitySnapHelper#createScroller(RecyclerView.LayoutManager)}
     *
     ...
     * <p>
     * When {@link com.example.highlighttime.helper.GravitySnapHelper#findSnapView(RecyclerView.LayoutManager)} returns null,
     * {@link com.example.highlighttime.helper.GravitySnapHelper#dispatchSnapChangeWhenPositionIsUnknown()} is called
     *
    ...
    /**
     * Calls {@link com.example.highlighttime.helper.GravitySnapHelper#findSnapView(RecyclerView.LayoutManager, boolean)}
    ...
    /**
     * A listener that's called when the {@link RecyclerView} used by {@link com.example.highlighttime.helper.GravitySnapHelper}
